...
import $ from 'jquery';
 ...
 class ParamsGame {
    ...
    drawSwitchAnimateSpeed() {
        ...
        this.colorPlayer2.innerHTML = '<div class="center center2"><div class="wrapper__pin wrapper__pin2"><div class="pin"></div></div></div><div class="wheel wheel2"><ul class="colors"><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li><li class="color"></li></ul></div>';
